...
stdtruncate <- function(T, sparse_para, smooth_para, Rank, niter = 20, use_latest_update = TRUE, is_first2modes_symmetric = FALSE) {
...
#############################################################
mytune <- function(T, rank_list = seq(1,3,1), sparse_list = seq(0.1, 0.9, 0.2), fuse_list = seq(0.1, 0.9, 0.2), tune_method = "together"){  
  # T: a tensor
